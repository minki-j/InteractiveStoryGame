...
plans: become a world class AI software engineer, build an AI story generating app(called Perfect Day) that puts the user as a main character in a story, and move to San Francisco to get funding and recruit like-minded engineers.
    """
}
...
while True:
    ...
    # Okay, I think I didn't give you the details of the app Perfect Day. It's a story generating app that has the user as a main character in a story. The intention of this app is to help people imagine their future and give them third person perspective on their current situation that would help them to realize what they should do to actually become like that. 
    # 
